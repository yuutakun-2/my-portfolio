...
const techstacks = [
  ...
  {
    title: "Frontend",
    icon: ["reactjs", "nextjs", "tailwindcss", "reactquery", "reactrouter", "redux", "wordpress"]
  },
  {
    title: "Backend",
  ...
  {
    title: "Production",
    icon: ["eslint", "postman", "vercel", "netlify", "docker", "railway", "linux", "neon"]
  },
  {
    ...
    >
      ...
      >
        {techstacks.map((techstack) => (
          <Box key={techstack.title} sx={{ display: "flex", flexDirection: "column", alignItems: "center", gap: 2, border: "1px solid #218A4E", borderRadius: 2, padding: 2, width: {xs: "100%", md: "fit-content"} }}>
            <Typography variant="h5" style={{ color: "#FFFFFF" }}>{techstack.title}</Typography>
            <Box sx={{ display: "flex", gap: 2, flexWrap: "wrap", justifyContent: "center" }}>
              {techstack.icon.map((icon) => (
                ...
                >
                  ...
                  <Box sx={{display: "flex", alignItems: "center"}} key={icon}>
                ...
                (<StackIcon key={icon} style={{ width: "40px", height: "auto" }} name={icon} alt={icon} />)
              ))}
            </Box>
          </Box>
        ))}
        {/* <StackIcon style={{ width: "40px", height: "auto" }} name="html5" />
        <StackIcon style={{ width: "40px", height: "auto" }} name="css3" />
        <StackIcon
          style={{ width: "40px", height: "auto" }}
          name="tailwindcss"
        />
        <StackIcon style={{ width: "40px", height: "auto" }} name="js" />
        <StackIcon
          style={{ width: "40px", height: "auto" }}
          name="typescript"
        />
        <StackIcon style={{ width: "40px", height: "auto" }} name="php" />
        <StackIcon style={{ width: "40px", height: "auto" }} name="laravel" />
        <StackIcon style={{ width: "40px", height: "auto" }} name="mysql" />
        <StackIcon style={{ width: "40px", height: "auto" }} name="figma" />
        <StackIcon style={{ width: "40px", height: "auto" }} name="eslint" />
        <svg
          xmlns="http://www.w3.org/2000/svg"
          viewBox="0 0 120 120"
          width="40"
        ...
        <StackIcon style={{ width: "40px", height: "auto" }} name="prisma" />
        <StackIcon style={{ width: "40px", height: "auto" }} name="reactjs" />
        <StackIcon
          style={{ width: "40px", height: "auto" }}
          name="reactquery"
        />
        <StackIcon
          ...
          name="reactrouter"
        />
        <StackIcon style={{ width: "40px", height: "auto" }} name="redux" />
        <StackIcon style={{ width: "40px", height: "auto" }} name="nextjs" />
        <StackIcon style={{ width: "40px", height: "auto" }} name="postman" />
        <StackIcon style={{ width: "40px", height: "auto" }} name="docker" />
        <StackIcon style={{ width: "40px", height: "auto" }} name="github" />
        <Box
          sx={{
            display: "flex",
            justifyContent: "center",
        ...
        <StackIcon style={{ width: "40px", height: "auto" }} name="netlify" />
        <StackIcon style={{ width: "40px", height: "auto" }} name="railway" />
        <StackIcon style={{ width: "40px", height: "auto" }} name="linux" />
        <StackIcon style={{ width: "40px", height: "auto" }} name="wordpress" /> */}
      </Box>
    </Container>
  );
}
